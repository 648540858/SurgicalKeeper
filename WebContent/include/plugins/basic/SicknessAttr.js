Ext.onReady(function(){
	...
	var centerPanel = Ext.create('Ext.panel.Panel',{
		...
		items : [Ext.create('Ext.grid.Panel',{
			...
			store : Ext.create('Ext.data.Store',{
				...
				proxy : {
					type : 'ajax',
					url  : root + '/sickness/listSicknessAttr.freda',
					actionMethods: {  
			            read: 'POST'  
			        },
					reader : {
			...
			columns : [{
				...
				name:'tplIcon',
				margin : '0 0 0 0',
				tpl:'<span><img src='+root+'/resources/wx{saIcon} style="vertical-align:middle;text-align:center;" width=14/>&nbsp;{saName}</span>'},{
				text : '创建时间',
				dataIndex : 'sacTime'
			},{
				text : '最后修改时间',
	...
	function submitFormInfo()
	{
		...
		{
			submitUrl += "/sickness/addSicknessAttr.freda";
		}
		else
		{
			submitUrl += "/sickness/editSicknessAttr.freda";
		}
	...
	function delData()
	{
		...
		Ext.Msg.show({
		    ...
		    fn: function(btn) {
		        if (btn === 'yes') {
		       		Ext.ux.Ajax.request({
					    url : root + '/sickness/delSicknessAttr.freda',
					    method : 'POST',
					    params : {
					    	ids : me.jsArray2JsString(record,'saId')
					    },

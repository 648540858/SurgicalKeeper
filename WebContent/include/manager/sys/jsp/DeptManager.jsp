...
<script type="text/javascript" src="<%=request.getContextPath()%>/include/manager/sys/js/DeptManager.js"></script>
	   ...
	   <tbody id="content" ></tbody>
		<script id="list" type="text/html">
 			{{each ROOT as value i}}
     			<tr>
					<td><input type="checkbox" name="grup" id="grup{{value.deptId}}" align="middle" value="{{value.deptId}}"/></td>
					<td>{{value.deptName}}</td>
					<td>{{value.deptSortNo}}</td>
					<td>{{value.deptDesc}}</td>
					<td>{{value.deptStatus}}</td>
     			</tr>
			{{/each}}
  		 </script>
		</table>
...
<div class="mytree">
	<div class="istree">
		<div id="tree_dept" class="ztree" style="width:100%; height="100%";overflow:auto;"></div>
	</div>
</div> 
<!-- 添加/编辑页面 -->
		...
		<div class="modal-content">
			...
			<div class="modal-body" >
				<div class="form-group">
					 <label for="deptName" class="col-sm-2 control-label text-center">名称</label>
					 <div class="col-sm-10">
			         	<input type="text" class="form-control" id="deptName" name="deptName"/>
			         </div>
			     </div>
			     <div class="form-group">
			         <label for="deptSortNo" class="col-sm-2 control-label text-center">序号</label>
			         <div class="col-sm-10">
			         	<input type="number" class="form-control" id="deptSortNo" name="deptSortNo"/>
			         </div>
			     </div>
			     <div class="form-group">
			         <label for="deptDesc" class="col-sm-2 control-label text-center">描述</label>
			         <div class="col-sm-10">
			         	<input type="text" class="form-control" id="deptDesc" name="deptDesc"/>
			         </div>
			     </div>
				<div class= "form-group ">
					<label for="deptStatus" class="col-sm-2 control-label text-center">状态</label>
					<div class="col-sm-10">
				    	<select id="deptStatus" class= "form-control"></select>
				    </div>
				</div>
			</div>

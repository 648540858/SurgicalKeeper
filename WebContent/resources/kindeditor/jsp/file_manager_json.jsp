 ...
 *
 */
 PropertiesHelper systemProperties=PropertiesFactory.getPropertiesHelper(PropertiesFile.SYS_PROPERTIES);
 ...
 String rootPath = fileDir + "/dataupload/kindattached/";
 //文件保存目录URL
 String rootUrl  = saveDir + "/dataupload/kindattached/";
//图片扩展名
